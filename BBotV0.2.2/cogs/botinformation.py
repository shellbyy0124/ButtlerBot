...
class ButtlerInformation(commands.Cog):
    ...
    async def binfo(self, ctx):
        ...
        buttler.add_field(name=f"Disclaimer:", value=f"Please keep in mind that I am always in development. I am always due to change at any given time. In the event that I ever change, add, or remove a characteristic from myself, I will always let you know in the announcements channel, or by typing `>bbupdates`")
