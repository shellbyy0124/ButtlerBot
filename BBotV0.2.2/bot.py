...
async def on_ready():
    ...
    cogs = ["cogs.dev", "cogs.generalcommands", "cogs.hiddencommands", "cogs.menu", "cogs.minigames", "cogs.profiles", "cogs.staff", "cogs.staffapplication", "cogs.teams", "cogs.welcome"]
