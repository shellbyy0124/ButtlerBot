...
class Administration(commands.Cog):
    ...
    async def staffhelpmenu(self, ctx):
        ...
        adminembed1.set_footer(text='Page 1/12')
        ...
        adminembed2.set_footer(text='Page 2/12')
        ...
        adminembed3.set_footer(text='Page 3/12')
        ...
        adminembed4.set_footer(text='Page 4/12')
        ...
        adminembed5.set_footer(text='Page 5/12')
        ...
        adminembed6.set_footer(text='Page 6/12')
        ...
        adminembed7.set_footer(text='Page 7/12')
        ...
        adminembed8.set_footer(text="Page 8/12")
        ...
        adminembed9.set_footer(text="Page 9/12")
        ...
        adminembed10.set_footer(text="Page 10/12")
        ...
        adminembed11.set_footer(text="Page 11/12")
        adminembed11.timestamp = datetime.datetime.utcnow()
        adminembed12 = discord.Embed(color=ctx.author.color).add_field(name="Closing A Support Channel?", value="Please be super careful with this command! `>!close` It will close ANY channel that it is invoked it. If this command is used improperly, you will be forced to step down!")
        adminembed12.set_thumbnail(url=self.bot.user.avatar_url)
        adminembed12.set_footer(text="Page 12/12")
        adminembed12.timestamp = datetime.datetime.utcnow()
