...
async def on_member_join(member:discord.Member):
    ...
    welcome.add_field(name="To Get Started:", value=f"You must be a member of {bot.get_guild(LT)} for at least 5 minutes before being able to chat with the community, so in the meantime I would like to cover some ground rules:", inline=False)
